...
import { validateImages } from "../src/lib/validators";
    ...
    describe("validateImages", () => {
        ...
        describe("should throws if", () => {
            ...
            it('required field "boundingBox" does not exist', () => {
                assert.throws(
                    () => {
                        return validateImages({ source: "image-path" }, { source: "image-path" });
                    },
                    TypeError,
                    'Field "boundingBox" does not exist',
                );
            });
                    ...
                    assert.throws(
                        () => {
                            return validateImages(
                                {
                                    source: "image-path",
                                    boundingBox: _.omit({ left: 0, top: 0, right: 0, bottom: 0 }, field),
                                },
                                {
                                    source: "image-path",
                                    boundingBox: _.omit({ left: 0, top: 0, right: 0, bottom: 0 }, field),
            ...
            it('"left" coordinate in "boundingBox" field greater than "right"', () => {
                assert.throws(
                    ...
                    TypeError,
                    '"left" coordinate in "boundingBox" field cannot be greater than "right"',
                );
            });
            ...
            it('"top" coordinate in "boundingBox" field greater than "bottom"', () => {
                assert.throws(
                    ...
                    TypeError,
                    '"top" coordinate in "boundingBox" field cannot be greater than "bottom"',
                );
            });
        });
    });
